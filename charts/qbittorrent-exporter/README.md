...
![Version: 1.2.0](https://img.shields.io/badge/Version-1.2.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.0.1](https://img.shields.io/badge/AppVersion-v2.0.1-informational?style=flat-square) ![Kubernetes: >=1.19.0-0](https://img.shields.io/badge/Kubernetes-%3E%3D1.19.0--0-informational?style=flat-square)

A Helm chart to export Prometheus metrics for qbittorrent.

Based on the [`martabal/qbittorrent-exporter`](https://github.com/martabal/qbittorrent-exporter) image.
