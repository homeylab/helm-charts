...
Every version's upgrade and migration notes for the `bookstack` chart, newest first. The [chart README](https://github.com/homeylab/helm-charts/blob/main/charts/bookstack/README.md)
