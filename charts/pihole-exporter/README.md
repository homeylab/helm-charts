...
_Upgrades from earlier majors are covered in the [full upgrade notes](https://github.com/homeylab/helm-charts/blob/main/charts/pihole-exporter/docs/upgrade.md)._
