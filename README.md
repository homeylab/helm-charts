...
| [nut_exporter](https://github.com/homeylab/helm-charts/tree/main/charts/nut-exporter) | **DEPRECATED** — use the first-party chart at [DRuggeri/nut_exporter](https://github.com/DRuggeri/nut_exporter) (`charts/nut-exporter`). [nut_exporter](https://github.com/DRuggeri/nut_exporter) is a Prometheus exporter that connects to a NUT server(s) and scrapes UPS backup metrics. |
